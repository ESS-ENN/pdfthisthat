...
<main class="h-full p-4 sm:px-5 lg:px-6 flex-grow">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl overflow-hidden p-4 mt-6">

    {{-- Success flash message ------------------------------------------------ --}}
    @if (session('success'))
        <div class="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800
                    text-green-800 dark:text-green-200 p-6 rounded-xl shadow-md m-8 text-base">
            <div class="flex items-center justify-between gap-4">
                ...
                <a href="{{ session('downloadLink') }}" target="_blank"
                   class="inline-flex items-center px-4 py-2 bg-green-100 dark:bg-green-800/50
                          hover:bg-green-200 dark:hover:bg-green-700 rounded-full text-sm font-semibold
                          transition-shadow shadow-sm hover:shadow-md mb-2"
    ...
    <div class="flex justify-center">
        <a href="/jpg_to_pdf"
           class="inline-flex items-center justify-center bg-primary-500 hover:bg-primary-600 text-white px-5 py-2.5 rounded-md text-xs font-medium transition shadow hover:shadow-md">
            <i class="fas fa-arrow-left mr-3 text-base"></i>
            Convert More JPGs to PDF
        </a>
    </div>
</div>
