...
<main class="flex-grow bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
        <div class="text-center mb-8">
            ...
            <h4 class="text-4xl font-extrabold text-primary-600 dark:text-primary-400 mb-3">Encrypt PDF</h1>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl overflow-hidden mt-6 p-12">
            ...
            <div class="flex justify-center">
                    <a href="/protect_pdf"  class="inline-flex items-center justify-center bg-primary-500 hover:bg-primary-600 text-white px-8 py-3 rounded-md text-sm font-semibold transition shadow-md hover:shadow-lg
