...
<main class="flex-grow bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden p-8">
            @if (session('success'))
                <div class="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 text-green-800 dark:text-green-200 p-4 rounded-lg shadow-sm m-8">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ session('download_link') }}" target="_blank"
                           class="inline-flex items-center px-3 py-1 bg-green-100 dark:bg-green-800/50 hover:bg-green-200 dark:hover:bg-green-700 rounded-full text-sm font-medium transition-colors" download="{{ session('download_name') }}">
                            Download PDF
                        </a>
                    </div>
                </div>
            ...
            <div class="flex justify-center">
                ...
                class="inline-flex items-center justify-center bg-primary-500 hover:bg-primary-600 text-white px-8 py-3 rounded-md text-sm font-semibold transition transform hover:-translate-y-0.5 active:translate-y-0 active:scale-95 ring-2 ring-transparent hover:ring-primary-300 focus:outline-none focus:ring-primary-400 focus:ring-offset-2 focus:ring-offset-white shadow">
                    ...
                    Convert More PDFs from word file
                </a>
            </div>
        </div>
