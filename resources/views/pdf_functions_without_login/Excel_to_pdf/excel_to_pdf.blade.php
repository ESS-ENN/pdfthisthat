...
<main class="h-full dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl overflow-hidden mb-4">
            ...
            @endif
            <form action="{{ route('guest_excel_to_pdf_functionality') }}" method="POST" enctype="multipart/form-data" class="space-y-8 p-8 sm:p-10" onsubmit="handleSubmit()">
                @csrf
                <!-- File Upload -->
                <div class="space-y-2">
                    <label class="block text-md font-medium text-gray-700 dark:text-gray-300">Choose Excel File</label>
                    <div class="mt-1 relative border-2 border-dashed border-primary-400 dark:border-primary-600 rounded-2xl p-12 text-center hover:border-primary-500 dark:hover:border-primary-500 transition-colors bg-gray-50/50 dark:bg-gray-700/30">
                        ...
                        <div class="flex flex-col items-center justify-center space-y-3">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400">Excel (.xlsx, .xls) up to 20MB</p>
                             <!-- preview  -->
...
<script>
    ...
    const pdfInput = document.getElementById('excel');
