...
<main class="flex-grow dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
  <div class="max-w-4xl mx-auto">
    ...
    <div class="text-center mb-8">
      ...
      <h4 class="text-4xl font-extrabold text-primary-600 dark:text-primary-400 mb-3">Redact PDF</h1>
      <p class="text-lg text-gray-600 dark:text-gray-300">Redact sensitive PDF information or data, and keep your content safe.</p>
    </div>

    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl overflow-hidden mt-6 p-12">
    
        <div class="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 text-green-800 dark:text-green-200 p-4 rounded-lg shadow-sm mb-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-2">
                    ...
                    <h5 class="text-green-800 dark:text-green-200 text-sm">Redacted PDF downloaded successfully.</h5>
                </div>
            </div>
        </div>

        <div class="flex justify-center">
                    <a href="/redact_pdf"  class="inline-flex items-center justify-center bg-primary-500 hover:bg-primary-600 text-white px-8 py-3 rounded-md text-sm font-semibold transition shadow-md hover:shadow-lg
