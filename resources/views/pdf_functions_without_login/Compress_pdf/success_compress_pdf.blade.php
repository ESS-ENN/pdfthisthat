...
<main class="flex-grow  bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden p-12 mt-8">
            ...
            @if (session('success'))
                <div class="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 text-green-800 dark:text-green-200 p-4 rounded-lg shadow-sm m-8">
                    ...
                    {{-- Top row: Message on left, download on right --}}
                    <div class="flex justify-between items-center flex-wrap gap-4">
                        <div class="flex items-center text-green-800 dark:text-green-200">
                            ...
                            <span class="font-semibold">Compression successful!</span>
                        </div>
                        <a href="{{ session('downloadLink') }}"
                        download="{{ session('download_name') }}"
                        target="_blank"
                        class="inline-flex items-center px-4 py-2 bg-green-100 dark:bg-green-800/50 hover:bg-green-200 dark:hover:bg-green-700 text-green-800 dark:text-green-100 rounded-full text-sm font-medium transition-colors">
                    ...
                    <div class="mt-3 space-y-1 text-sm">
                        <p><span class="font-medium">Original size:</span> {{ session('original_size') }}</p>
                        <p><span class="font-medium">Compressed size:</span> {{ session('compressed_size') }}</p>
                        <p><span class="font-medium">Reduced by:</span> {{ session('reduction') }}</p>
                    </div>
            ...
            <div class="flex justify-center ">
                <a href="/compress_pdf"
                class="inline-flex items-center justify-center bg-primary-500 hover:bg-primary-600 text-white px-8 py-3 rounded-md text-sm font-semibold transition transform hover:-translate-y-0.5 active:translate-y-0 active:scale-95 ring-2 ring-transparent hover:ring-primary-300 focus:outline-none focus:ring-primary-400 focus:ring-offset-2 focus:ring-offset-white shadow">
