...
<main class="h-full bg-gray-50 dark:bg-gray-900 py-6 px-2 sm:px-4 lg:px-6">
    <div class="max-w-4xl mx-auto">
        <div class="text-center mb-4">
            ...
            <h4 class="text-3xl font-bold text-primary-600 dark:text-primary-400 mb-2">Organize PDF</h1>
            <p class="text-base text-gray-600 dark:text-gray-300">Rearrange or remove pages from your PDF.</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl overflow-hidden mb-3">
            ...
            <form action="{{ route('organize_pdf_functionality') }}" method="POST" enctype="multipart/form-data" class="space-y-6 p-6 sm:p-8" onsubmit="handleSubmit()">
                @csrf
                ...
                <!-- Page Order and Remove Pages Side by Side -->
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <!-- Page Order -->
                        <div class="space-y-1">
                            <label for="page_order" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Page Order</label>
                            <input type="text" name="page_order" id="page_order" placeholder="e.g., 1,3,2" required class="w-full border border-gray-300 dark:border-gray-600 rounded-md p-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500">
                            <p class="text-xs text-gray-500 dark:text-gray-400">Enter new page order (comma-separated)</p>
                        </div>
                ...
                <!-- Submit -->
                <button type="submit" id="organizeBtn" class="w-full flex items-center justify-center px-4 py-3 bg-gradient-to-r bg-primary-500 hover:bg-primary-600 text-white font-medium rounded-lg transition-all duration-300">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v16h16V4H4zm4 4h8M8 12h8M8 16h5" />
                    </svg>
                    Upload and Rearrange
                </button>
            </form>
        </div>
    </div>
