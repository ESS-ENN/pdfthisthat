...
<main class="flex-grow bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
        ...
        {{-- Merge Form --}}
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl overflow-hidden p-6 mt-6">
                 <!-- Flash Messages  -->
            @if (session('success'))
            ...
            <div class="flex justify-center mb-8">
                    <a href="/merge_pdf"  class="inline-flex items-center justify-center bg-primary-500 hover:bg-primary-600 text-white px-8 py-3 rounded-md text-sm font-semibold transition shadow-md hover:shadow-lg
