...
<main class="flex-grow p-6">
    <div class="text-center">
        ...
        <h4 class="text-4xl font-extrabold text-primary-600 dark:text-primary-400 mb-3">Unlock PDF</h1>
        <p class="text-lg text-gray-600 dark:text-gray-300">Upload a password-protected PDF, enter the password, and decrypt the file for download.</p>
    </div>
    <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-2xl overflow-hidden mt-6 p-12">
            @if (session('success'))
            ...
            <div class="flex justify-center">
                    <a href="/unlock_pdf"  class="inline-flex items-center justify-center bg-primary-500 hover:bg-primary-600 text-white px-8 py-3 rounded-md text-sm font-semibold transition shadow-md hover:shadow-lg
